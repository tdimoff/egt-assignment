...
function UserEditForm({ user, onCancel, onSuccess }: IUserEditFormProps) {
    ...
    function onSubmit(data: IFormValues) {
      dispatch(updateUserThunk({id: user.id, ...data}))
        .then(onSuccess)
    }
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField 
                ...
                helperText={errors.company?.name ? errors.company.name.message : ' '}
              />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <TextField 
                ...
                helperText={errors.address?.suite ? errors.address.suite.message : ' '}
              />
            </Grid>
            <Grid item xs={12}>
              <TextField 
